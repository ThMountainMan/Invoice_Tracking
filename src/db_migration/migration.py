...
def run_migrations(script_location: str, dsn: str) -> None:
    ...
    Logger.info(f"Current DB Version is : {current_db_version}")
    ...
    elif "head" not in current_db_version:
        Logger.info("DB is NOT up to date ...")
...
if __name__ == "__main__":
    run_migrations(
        r"D:\Development\Projects\Invoice_Tracking\src\db_migration",
