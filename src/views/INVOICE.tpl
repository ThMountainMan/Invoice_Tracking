...
<body>
  <header>
    ...
    <address contenteditable>
      <p>{{invoice.id}}</p>
      <p>{{invoice.customer.name}}<br>{{invoice.customer.street}}<br>{{invoice.customer.postcode}} {{invoice.customer.city}}<br>{{invoice.customer.country}}</p>
      <p>(800) 555-1234</p>
    </address>
  ...
  <article>
    ...
    <table class="meta">
      ...
      <tr>
        ...
        <td><span id="prefix" contenteditable>€</span><span>{{invoice.invoice_ammount}}</span></td>
      </tr>
    </table>
