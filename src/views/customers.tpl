      ...
      <table class="table table-hover" id="tableedit">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#showdata_{{ customer.id }}">
                EDIT
              </button>
          </tr>

          <!-- EDIT existing Customer -->
          <div class="modal fade" id="showdata_{{ customer.id }}" tabindex="0" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
                ...
                <div class="modal-body">
                  <form method="post" action="/payment_edit" id="form_{{ customer.id }}">
                    ...
                    <div class="form-group required">
                      ...
                      <input type="text" class="form-control" name="contact" required value="{{ customer.contact }}" />
                    </div>
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-3 mb-3">
                        <div class="form-group required">
                          ...
                          <input type="text" class="form-control" name="postcode" required value="{{ customer.postcode }}"/>
                        </div>
                      </div>
                    </div>
