            ...
            <table class="table table-hover" id="tableedit">
                ...
                <tr class="table-warning">
                    ...
                    <td>
                        ...
                        <!-- The Modal -->
                        <div class="modal fade bd-example-modal-xl" id="showInvoice">
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <iframe src='/invoice/display/{{invoice.id}}' width="100%" height="1000"
                                    ...
                                    <div class="modal-footer">
                                        <button onclick="window.location.href = '/invoice/download/{{invoice.id}}';"
                                            type="button" class="btn btn-primary"><i
                                                class="fa fa-download"></i> DOWNLAOD</button>
